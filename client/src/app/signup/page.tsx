...
export default function SignupPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] bg-background px-4 py-8 relative overflow-hidden">
      <div className="absolute top-1/4 right-1/4 w-48 h-48 md:w-72 md:h-72 bg-pink-500/20 rounded-full blur-3xl -z-10 animate-pulse" />
      <div className="absolute bottom-1/4 left-1/4 w-48 h-48 md:w-72 md:h-72 bg-blue-500/20 rounded-full blur-3xl -z-10 animate-pulse delay-1000" />
      ...
      <motion.div
        ...
        className="w-full max-w-lg p-6 md:p-8 rounded-2xl glass border border-white/10 shadow-2xl relative overflow-hidden"
      >
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-pink-500 to-blue-500" />

        <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center text-white">Join SkillSwap</h2>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-2.5 mt-2 rounded-md bg-primary text-primary-foreground font-medium hover:bg-primary/90 transition-all active:scale-[0.98]"
          >
            Create Account
          </button>
        </form>
